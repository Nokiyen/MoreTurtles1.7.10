...
public class PeripheralBiomeHosted implements IPeripheral {
	...
	private Object[] getAboutBiome(int method, Object[] arguments) throws LuaException, InterruptedException {
		...
		BiomeGenBase biome = this.turtle.world.getBiomeGenForCoords(this.turtle.posX, this.turtle.posZ);
		...
		case 4:
			return new Object[] {biome.getFloatTemperature(this.turtle.posX, this.turtle.posY, this.turtle.posZ)};
		case 5:
