...
public class PeripheralLuckHosted implements IPeripheral {
	...
	public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
		...
		switch(method) {
			...
			case 2:
				return this.tryCommand(context, TurtleVerb.Dig, 1);
			case 3:
				return this.tryCommand(context, TurtleVerb.Dig, 0);
			case 4:
				return this.tryCommand(context, TurtleVerb.Attack, this.turtle.getDirection());
			case 5:
				return this.tryCommand(context, TurtleVerb.Attack, 1);
			case 6:
				return this.tryCommand(context, TurtleVerb.Attack, 0);
			default:
	...
	private Object[] tryCommand(ILuaContext context, TurtleVerb verb, int dir)
			throws LuaException, InterruptedException {
