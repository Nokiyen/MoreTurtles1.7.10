...
public class PeripheralProjectileCommand implements ITurtleCommand {
	...
	public TurtleCommandResult execute(ITurtleAccess givenTurtle) {
		...
		//	get entity.
		double x = this.turtle.posX + Facing.offsetsXForSide[this.turtle.getDirection()] + 0.5D;
		double y = this.turtle.posY + Facing.offsetsYForSide[this.turtle.getDirection()] + 0.5D;
		double z = this.turtle.posZ + Facing.offsetsZForSide[this.turtle.getDirection()] + 0.5D;
...
//			return MTTurtleAccess.result(false, EFailureReason.JAVA);
	...
	private class ShootSource implements IBlockSource {		
		...
		@Override
		public int getXInt() {
			return this.turtle.posX;
		}

		@Override
		public int getYInt() {
			return this.turtle.posY;
		}

		@Override
		public int getZInt() {
			return this.turtle.posZ;
		}
